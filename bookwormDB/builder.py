from ducksauce import quacksort
import duckdb
import numpy as np
...
class BookwormCorpus(Corpus):
    ...
    def prepare_metadata(self):
        Catalog(self.metadata.tb).to_flat_catalog(self.metadata)
    ...
    def create_table_schemas(self):
        ...
        rich = Catalog(self.metadata.tb).feather_ld()
    ...
    def update_wordcounts(self):
        bookid_wordcounts = self.bookid_wordcounts
        rel = self.con.register_arrow("my_nwords", bookid_wordcounts)
