...
general_prefs["presidio"] = {"HOST":"localhost","database":"presidio","fastcat":"fastcat","fullcat":"open_editions","fastword":"wordsheap","read_default_file":"/etc/mysql/my.cnf","fullword":"words","separateDataTables":["LCSH","gender"],"read_url_head":"http://www.archive.org/stream/"}
...
general_prefs["HistoryDissTest"] = {"fastcat": "fastcat", "HOST": "localhost", "separateDataTables": ["keywords"], "fastword": "wordsheap", "database": "HistoryDissTest", "read_url_head": "arxiv.culturomics.org", "fullcat": "catalog", "fullword": "words", "read_default_file": "/etc/mysql/my.cnf"}
